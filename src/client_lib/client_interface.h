...
#include "../shared/interface_types.h"
...
private slots:
    void complete(noo::AnyVar, QString);

signals:
    void recv_data(noo::AnyVar&);
...
signals:
    void recv(QString, noo::Selection);
};
...
public:
    ...
    void request_deletion(noo::SelectionRef) const;

    void request_selection(QString) const;
    void request_set_selection(QString, noo::SelectionRef) const;
...
signals:
    ...
    void on_request_selection(QString, noo::Selection) const;
