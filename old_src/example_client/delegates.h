...
class ExBuffer : public nooc::BufferDelegate, public ComponentListItem {
    ...
    std::unique_ptr<Qt3DRender::QBuffer> m_3d_entity;
...
class ExMaterial : public nooc::MaterialDelegate, public ComponentListItem {
    ...
    std::unique_ptr<QInstancedMetalRoughMaterial> m_3d_entity;
...
class ExLight : public nooc::LightDelegate, public ComponentListItem {
    ...
    std::unique_ptr<Qt3DRender::QAbstractLight> m_3d_entity;
...
struct QtGeomInfo {
    std::unique_ptr<Qt3DRender::QGeometry>         geom;
    std::unique_ptr<Qt3DRender::QGeometryRenderer> renderer;

    QByteArray                              instance_data;
    std::unique_ptr<Qt3DRender::QBuffer>    instance_buffer;
    std::unique_ptr<Qt3DRender::QAttribute> instance_attribute;
};
...
class ExObject : public nooc::ObjectDelegate {
    QTreeWidgetItem*                 m_tree_root;
    std::unique_ptr<QTreeWidgetItem> m_tree_item;

    Qt3DCore::QEntity*          m_3d_root;
    QPointer<Qt3DCore::QEntity> m_3d_entity;
